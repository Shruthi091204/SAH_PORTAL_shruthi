  ...
  return (
    <div style={{ background: '#f4f7f9', minHeight: '100vh' }}>
      ...
      <div style={{ 
        ...
        {/* Register Now & Submit Buttons in Hero Right */}
        <div style={{ position: 'absolute', top: '40px', right: '40px', zIndex: 30, display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'flex-end' }}>
          ...
          <a 
            ...
            href="https://forms.cloud.microsoft/r/zKShTqvBPk"
            target="_blank"
          ...
          <div style={{ background: '#fff', borderRadius: '24px', padding: '40px', boxShadow: '0 20px 40px -15px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '24px' }}>
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: '6px' }}>Project Info Sheet</div>
                  <div style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Word Document (Available)</div>
                </div>
              </button>
